...
export declare class ADTClient {
     ...
     */
    constructor(baseUrl: string, username: string, password: string | BearerFetcher, client?: string, language?: string, options?: ClientOptions);
    private createHttp;
    private wrapFetcher;
    ...
    nodeContents(parent_type: NodeParents, parent_name?: string, user_name?: string, parent_tech_name?: string): Promise<NodeStructure>;
    ...
    objectStructure(objectUrl: string): Promise<AbapObjectStructure>;
     ...
     */
    getObjectSource(objectSourceUrl: string, gitUser?: string, gitPassword?: string): Promise<string>;
    ...
    codeCompletionFull(sourceUrl: string, source: string, line: number, column: number, patternKey: string): Promise<any>;
    runClass(className: string): Promise<any>;
    /**
    ...
    runUnitTest(url: string): Promise<UnitTestClass[]>;
    ...
    setPrettyPrinterSetting(indent: boolean, style: PrettyPrinterStyle): Promise<any>;
    prettyPrinter(source: string): Promise<any>;
    ...
    transportReference(pgmid: string, obj_wbtype: string, obj_name: string): Promise<string>;
    ...
    debuggerSetBreakpoints(debuggingMode: "user", terminalId: string, ideId: string, clientId: string, breakpoints: (string | DebugBreakpoint)[], user: string, scope?: DebuggerScope, systemDebugging?: boolean, deactivated?: boolean): Promise<(DebugBreakpoint | DebugBreakpointError)[]>;
    debuggerSetBreakpoints(debuggingMode: DebuggingMode, terminalId: string, ideId: string, clientId: string, breakpoints: (string | DebugBreakpoint)[], user?: string, scope?: DebuggerScope, systemDebugging?: boolean, deactivated?: boolean): Promise<(DebugBreakpoint | DebugBreakpointError)[]>;

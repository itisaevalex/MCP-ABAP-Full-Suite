...
export declare type DebuggingMode = "user" | "terminal";
...
export declare type DebugStackType = "ABAP" | "DYNP" | "ENHANCEMENT";
export declare type DebugStackSourceType = "ABAP" | "DYNP" | "ST";
...
export declare type DebugStack = DebugStackAbap | DebugStackVit | DebugStackSimple;
...
export declare type DebugMetaTypeSimple = "simple" | "string" | "boxedcomp" | "anonymcomp" | "unknown";
export declare type DebugMetaTypeComplex = "structure" | "table" | "dataref" | "objectref" | "class" | "object" | "boxref";
export declare type DebuggerScope = "external" | "debugger";
export declare type DebugMetaType = DebugMetaTypeSimple | DebugMetaTypeComplex;
...
export declare type DebugStepType = "stepInto" | "stepOver" | "stepReturn" | "stepContinue" | "stepRunToLine" | "stepJumpToLine" | "terminateDebuggee";
...
export declare function debuggerSetBreakpoints(h: AdtHTTP, debuggingMode: DebuggingMode, terminalId: string, ideId: string, clientId: string, breakpoints: (DebugBreakpoint | string)[], requestUser?: string, scope?: DebuggerScope, systemDebugging?: boolean, deactivated?: boolean): Promise<(DebugBreakpoint | DebugBreakpointError)[]>;
...
export declare function debuggerSetVariableValue(h: AdtHTTP, variableName: string, value: string): Promise<any>;

...
export declare function codeCompletionFull(h: AdtHTTP, url: string, body: string, line: number, offset: number, patternKey: string): Promise<any>;
...
export declare type PrettyPrinterStyle = "toLower" | "toUpper" | "keywordUpper" | "keywordLower" | "keywordAuto" | "none";
...
export declare function setPrettyPrinterSetting(h: AdtHTTP, indent: boolean, style: PrettyPrinterStyle): Promise<any>;
export declare function prettyPrinter(h: AdtHTTP, body: string): Promise<any>;

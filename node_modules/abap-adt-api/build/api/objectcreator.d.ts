...
export declare type PackageTypeId = "DEVC/K";
export declare type GroupTypeIds = "FUGR/FF" | "FUGR/I";
export declare type BindingTypeId = "SRVB/SVB";
export declare type NonGroupTypeIds = "CLAS/OC" | "FUGR/F" | "INTF/OI" | "PROG/I" | "PROG/P" | "DCLS/DL" | "DDLS/DF" | "DDLX/EX" | "DDLA/ADF" | "TABL/DT" | "SRVD/SRV" | "AUTH" | "DTEL/DE" | "SUSO/B" | "MSAG/N";
export declare type ParentTypeIds = "DEVC/K" | "FUGR/F";
export declare type CreatableTypeIds = GroupTypeIds | NonGroupTypeIds | PackageTypeId | BindingTypeId;
...
export declare type PackageTypes = "development" | "structure" | "main";
...
export declare type BindingCategory = "0" | "1";
...
export declare type ValidateOptions = ObjectValidateOptions | GroupValidateOptions | PackageValidateOptions | BindingValidationOptions;

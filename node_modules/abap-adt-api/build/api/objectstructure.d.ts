...
export declare type classIncludes = "definitions" | "implementations" | "macros" | "testclasses" | "main";
...
export declare type AbapMetaData = GenericMetaData | ProgramMetaData | FunctionGroupMetaData | ClassMetaData;
...
export declare type AbapObjectStructure = AbapSimpleStructure | AbapClassStructure;
...
export declare function objectStructure(h: AdtHTTP, objectUrl: string): Promise<AbapObjectStructure>;
